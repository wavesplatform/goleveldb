...
Forked from [syndtr/goleveldb](https://github.com/syndtr/goleveldb).
...
-----------
	...
	go get github.com/wavesplatform/goleveldb
...
You can read package documentation [here](https://pkg.go.dev/github.com/wavesplatform/goleveldb).
